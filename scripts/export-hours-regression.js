...
for(const name of ['normalizeSchoolNameForExport','normalizeExportClassType','mapExportAttendanceStatus','buildExportClassName','formatTime','exportScheduleToExcel'])vm.runInContext(extract(name),context);
