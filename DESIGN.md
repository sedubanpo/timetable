...
Preserve dense desktop comparison with an 1800px table minimum to keep inline fields inside columns; narrower screens scroll the timetable, not the toolbar. Existing mobile sizing remains. Toolbar actions wrap while labels stay intact. Student rows do not wrap. Note bubbles retain their 220px reading width. Calendar controls remain Monday-first and unchanged.
